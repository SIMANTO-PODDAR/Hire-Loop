        ...
        <div>
            ...
            <div className="mt-2 sm:mt-10 mb-10 p-7 sm:p-0 flex justify-center scale-90 sm:scale-100">
                ...
                <div className="justify-center mt-5">
                    ...
                    <h1 className="font-bold text-center opacity-80 mt-3">No account yet? <Link href='/auth/signup' className="underline italic text-violet-500 opacity-100">Register Here</Link></h1>
                </div>
            </div>
        </div>
    );
